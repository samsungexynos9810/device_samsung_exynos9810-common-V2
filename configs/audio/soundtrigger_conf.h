...
#define PRIMARY_VTS_PERIOD_SIZE           480     // 480 frames, 30ms in case of 16KHz Stream
#define PRIMARY_VTS_PERIOD_COUNT          128     // Buffer count => Total  122880 Bytes = 480 * 1(Mono) * 2(16bit PCM) * 128(Buffer count)
